...
/*    public String city;
   ...
   /* public Weather() {}
    ...
    public Weather(@NonNull String city, float temp, float feelsLike) {
        this.city = city;
        this.temp = temp;
        this.feelsLike = feelsLike;
    ...
    static Long getWeatherLastUpdate() {
        SharedPreferences sharePref = MyApplication.getMyContext().getSharedPreferences("TAG", Context.MODE_PRIVATE);
        return sharePref.getLong(LOCAL_LAST_UPDATE, 0);
    }
...
/*
    ...
    static final String FEELS_LIKE = "feelsLike";
    static final String LAST_UPDATE = "lastUpdate";
    static final String LOCAL_LAST_UPDATE = "WeatherLocalLastUpdate";*/


/*    public static Map<String, Object> toJson(Weather weather) {
        Map<String, Object> json = new HashMap<>();
        json.put("city", weather.city);
        json.put("temp", weather.temp);
        json.put("feelsLike", weather.feelsLike);
        json.put("lastUpdate", FieldValue.serverTimestamp());
        return json;
    ...
    public static Weather fromMap(Map<String, Object> map) {
        String city = (String) map.get(CITY);
        float temp = ((Number) map.get(TEMP)).floatValue();
        float feelsLike = ((Number) map.get(FEELS_LIKE)).floatValue();
        Weather weather = new Weather(city, temp, feelsLike);
        if (map.containsKey(LAST_UPDATE)) {
            weather.setLastUpdate((Long) map.get(LAST_UPDATE));
        }
        return weather;
    }*/
}
